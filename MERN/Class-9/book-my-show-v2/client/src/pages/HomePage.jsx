    ...
    <Box sx={{ bgcolor: '#f5f5f5', minHeight: '100%' }}>
        ...
        <Container maxWidth="lg">
          <Stack spacing={2} sx={{ maxWidth: 650 }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ pt: 1 }}>
              <Button variant="contained" size="large" component={RouterLink} to="/login" sx={{ bgcolor: '#f84464', px: 3, '&:hover': { bgcolor: '#d93452' } }}>
                Book tickets
              </Button>
              <Button variant="outlined" size="large" component={RouterLink} to="/signup" sx={{ borderColor: 'rgba(255,255,255,0.7)', color: 'common.white', px: 3, '&:hover': { borderColor: 'common.white', bgcolor: 'rgba(255,255,255,0.08)' } }}>
                Create account
              </Button>
            </Stack>
          </Stack>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
        <Stack direction="row" alignItems="baseline" justifyContent="space-between" sx={{ mb: 3 }}>
          ...
          <Typography sx={{ color: '#f84464', fontWeight: 600, display: { xs: 'none', sm: 'block' } }}>See All ›</Typography>
        </Stack>
