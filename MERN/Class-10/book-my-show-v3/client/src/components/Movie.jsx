    ...
    return (
        ...
        >
            ...
            <Box sx={{ px: 0.5, pt: 1.5 }}>
                ...
                <Button component="span" fullWidth variant="outlined" size="small" sx={{ mt: 1.25, borderColor: '#f84464', color: '#f84464', fontWeight: 700, '&:hover': { borderColor: '#d93452', bgcolor: '#fff1f3' } }}>
                    View details
                </Button>
            </Box>
        </Card>
